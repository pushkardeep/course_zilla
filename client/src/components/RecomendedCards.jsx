...
function RecomendedCards({ id, title, description, image }) {
  ...
  return (
    <div
      onClick={onclick}
      className="w-full sm:w-[50%] md:w-full h-fit px-1.5 py-1.5  md:hover:bg-[#3b3b3b] rounded-xl active:bg-[#111111] transition-all cursor-pointer"
    >
      ...
      <div className="w-full h-fit flex justify-between items-center gap-1.5 px-1 py-1">
        ...
        <div className="flex-1 flex justify-between items-center">
          <div className="w-full h-fit leading-[13.5px]">
